...
def get_model():
  ...
  algo = "ppo"
  folder = "/Users/userok/Desktop/Imperial_final_report/Code_base/trained_models_SB3/rl-baselines3-zoo/rl-trained-agents/"
  ...
  try:
      ...
      for _ in generator:
          ...
          obs, reward, done, infos = env.step([[-0.06670591, -0.32395223,  0.40453988,  0.11783605]])
